...
// clang-format off
constexpr std::array<const char*, 135> s_hotkey_labels{{
    _trans("Open"),
    _trans("Change Disc"),
    _trans("Eject Disc"),
    ...
    _trans("Force Controller Config Refresh"),
...
constexpr std::array<HotkeyGroupInfo, NUM_HOTKEY_GROUPS> s_groups_info = {
    {{_trans("General"), HK_OPEN, HK_REQUEST_GOLF_CONTROL},
     ...
     {_trans("Controller Profile"), HK_FORCE_RELOAD_CONTROLLER_CONFIG, HK_PREV_GAME_WIIMOTE_PROFILE_4},
